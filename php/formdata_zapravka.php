...
// Пишет ошибку в поле VALUES, типа нельзя писать $_POST
 ...
 //$date = "2015.01.16";
 $sql = 'INSERT INTO gurnal_zapravky(date, kabinet, model_printer, work, materialy, name_prac)
 VALUES("'.$_POST['date'].'","'.$_POST['kabinet'].'","'.$_POST['model_printer'].'","'.$_POST['work'].'","'.$_POST['materialy'].'" ,"'.$_POST['name_prac'].'")';
